...
var saveOptions = function () {
    ...
    return extension.options.sync.save().then(function () { return flashMessage('Options saved.'); }, function () { return flashMessage('Error when saving options.'); });
};
// Restores select box and checkbox state using the preferences
// stored in chrome.storage.
var restoreOptions = function () {
    extension.options.sync.load().then(function () {
        var values = extension.options.sync.values;
